...
class InferenceTask:
    ...
    # init_seq: 처음 시작 할 때의 문장... 주어진 메타데이터 이어붙인 것...?
    # init_mems: 이걸 모델에 통과시켜서 나온 결과...?
    ...
    """
    메타데이터에서 시작해서, sequence를 끝까지 만듦.
    처음엔 seq에 메타데이터가 들어있고,
    for 문을 거치면서 seq에 토큰이 계속 추가되는 방식.
    """
