...
from commu.model.linformer import LinformerLM
...
#model = LinformerLM(num_tokens=800, dim=512, seq_len=1024, depth=6, k = 256, heads = 8, dim_head = None, one_kv_head = False, share_kv = False, reversible = False, dropout = 0.)
